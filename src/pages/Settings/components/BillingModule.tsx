      ...
      >
        ...
        <div className="p-5 rounded-2xl border bg-slate-50/50" style={{ borderColor: '#E2E8F0', boxShadow: 'none' }}>
          <div className="flex items-center justify-between border-b pb-3 mb-4">
            <h4 className="text-xs font-bold text-slate-800">Subscription Overview</h4>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-5 rounded-2xl border bg-white" style={{ borderColor: '#E2E8F0', boxShadow: 'none' }}>
