...
import { SectionHeader, TableHeader, CardTitle, ModalHeader } from '../../components/ui/Typography';
...
const SupplierComponent: React.FC = () => {
  ...
  const codeSetting = useMemo(() => {
    try {
      ...
      return getCodeSettingsForBranch(currentCoId, currentBrId).supplier;
    } catch {
      return { mode: 'manual', prefix: 'SUP-', digits: 4, nextNumber: 1 };
    }
  }, [showModal]);
                        ...
                        {paginatedCustomers.map((cust, i) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              {/* Supplier Details */}
                              {supplierSettings.columns['Business Partner Details'] && (
                      ...
                      <Card className="p-4" style={{ borderColor: '#E2E8F0', boxShadow: 'none' }}>
                        <div className="space-y-4">
                          <div className="flex items-center gap-6 flex-wrap pt-1">
                            {supplierSettings.fields['Walk-in Customer'] && <Toggle checked={editing.is_walkin} onChange={(v) => setEditing({ ...editing, is_walkin: v })} label="Walk-in Retail Business Partner" />}
