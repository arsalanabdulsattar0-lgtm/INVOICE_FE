                    ...
                    <div className="grid grid-cols-3 gap-3">
                      {[
                        ...
                        <div key={field.key} className="space-y-1">
                          <span className="text-[8px] font-black uppercase tracking-widest opacity-50" style={{ color: brand.dark }}>{field.label}</span>
                          <input
                            type="number"
                            className="w-full bg-slate-50 border rounded-lg py-1.5 px-3 text-xs font-black outline-none"
                            style={{ color: brand.dark, borderColor: brand.dark + '10' }}
...
export default InvoiceEditorV3;
