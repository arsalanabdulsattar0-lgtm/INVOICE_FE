...
const PurchaseList: React.FC<PurchaseListProps> = ({ onViewChange, purchaseItems, setPurchaseItems, onPrintPurchase, onEditPurchase, onPrintList }) => {
  ...
  return (
    <div className="h-full p-6 flex flex-col gap-5" style={{ background: 'transparent', minHeight: 'calc(100vh - 70px)' }}>

      {/* ── Page Header ── */}
      <PageHeader
        title="Purchase List"
        subtitle={`${filtered.length} purchases found · Last updated just now`}
        actions={
