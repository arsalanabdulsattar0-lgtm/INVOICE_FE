...
export const Select: React.FC<SelectProps> = ({
  ...
  const baseClasses = isCompact
    ...
    : `w-full border rounded-xl h-10 pl-4 pr-10 text-[13px] font-normal ${valueColorClass} appearance-none cursor-pointer outline-none transition-all form-select-container bg-white`;
  ...
  return (
    ...
    >
      {label && (
        <label className="text-[13px] font-semibold text-slate-700 ml-0.5 flex items-center gap-1">
          {label}
        </label>
      )}
